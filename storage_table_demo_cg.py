...
resourcegroup_name = 'cpg'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
storageaccount_name = 'cpg'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
location = 'eastus'
...
car.color = 'blue'
table_service.insert_entity('itemstable', car)
print('Created entry for Cadillac...')
...
coffee.RowKey = '005'
coffee.brand = 'Blue Mountain'
coffee.flavor = 'Smokey'
coffee.size = 'L'
coffee.price = 3.50
table_service.insert_entity('itemstable', coffee)
print('Created entry for a Coffee BM...\n')
time.sleep(1)

coffee = Entity()
coffee.PartitionKey = 'coffeeshop'
coffee.RowKey = '006'
coffee.brand = 'Sumatra'
coffee.flavor = 'Superior'
coffee.size = 'S'
coffee.price = 2.50
table_service.insert_entity('itemstable', coffee)
print('Created entry for Coffee Sumatra...\n')
time.sleep(1)
